...
<meta property="og:url" content="https://nightproject.net" />
<meta property="og:locale" content="ru_RU"/>
<meta property="og:type" content="website" />
<meta property="og:site_name" content="NightProject" />
...
<meta name="twitter:site" content="@yushiko">
<meta name="twitter:creator" content="@yushiko">
...
<body>
<img src="https://media.discordapp.net/attachments/901768860397600798/1002375487621976085/39_20220729053244.png?width=679&height=679" width="1" height="1" alt="preload"/>
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 NightProject - не большая компания занимающаяся разработкой ботов в Discord
							</p>
							<div class='landing-btn-container'>
								<div class="build-btn-button">
									<div class="build-ico-button">
										<div class="build-ico-os">
											<img alt="Invite" src="https://cdn.discordapp.com/attachments/901768860397600798/1002345266638229544/external-link.png" style='height: 100%; width: 100%; object-fit: contain'/>
											<img alt="Invite"   src="https://cdn.discordapp.com/attachments/901768860397600798/1002345267003129966/link.png" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
										</div>
									</div>
									<a href="https://discord.com/api/oauth2/authorize?client_id=996884597616939050&permissions=8&scope=bot" target="_blank">
									<div class="build-tx1-button">
										<span>Invite</span>
										<span class="build-tx2-label">free</span>
									</div>
									</a>
								</div>
							</div>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(https://media.discordapp.net/attachments/901768860397600798/1002375487621976085/39_20220729053244.png?width=679&height=679) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 Мы используем Discord для размещения новостей.Discord позволяет нам поддерживать с вами обратную связь для улучшения нашего проекта.Это относится к новым и старым пользователям, которые хотят оставаться в курсе событий и помогать развитию проекта.
								</p>
							</div>
							<a href="https://discord.gg/WNW2h3CzYr" target="_blank">
